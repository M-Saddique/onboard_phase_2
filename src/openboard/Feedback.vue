...
export default {
  ...
  data() {
    return {
      ...
      feedbackQuestions: [
        {title:'Are you registered on dlivrd? 1', value:null},
        {title:'Are you registered on dlivrd? 2', value:null},
        {title:'Are you registered on dlivrd? 3', value:null},
        {title:'Are you registered on dlivrd? 4', value:null},
        {title:'Are you registered on dlivrd? 5', value:null},
      ],
      comments: null,
    };
  },
      ...
      axios.post(url, data, {
        ...
        if(response.status == 200){
          if(response.data['Success']){
            ...
            this.allowFeedback = false;
            this.loading = true;
            this.allowFeedbackResponse = "Your feedback is under review. You can submit a new feedback after 7 days."
          }
          else{
